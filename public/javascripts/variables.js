...
const twoPlayersMap = [{x:18, y:6}, {x:73, y:39}];
const threePlayersMap = [{x:18, y:6}, {x:75, y:6}, {x:43, y:42}];
const fourPlayersMap = [{x:18, y:6}, {x:5, y:42}, {x:75, y:6}, {x:73, y:39}];
...
const sevenPlayersMap = [{x:18, y:6}, {x:8, y:25}, {x:5, y:42}, {x:43, y:42}, {x:75, y:6}, {x:70, y:25}, {x:73, y:39}];
const eightPlayersMap = [{x:18, y:6}, {x:8, y:25}, {x:5, y:42}, {x:43, y:42}, {x:43, y:6}, {x:75, y:6}, {x:70, y:25}, {x:73, y:39}];
